...
Node::Node(int val) : val(val), left(nullptr), right(nullptr), next(nullptr) {}

Node::Node(int val, Node* left, Node* right, Node* next) : val(val), left(left), right(right), next(next) {}
